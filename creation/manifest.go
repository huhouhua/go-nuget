...
//	Readme                   string
//
//	// FrameworkReferences Specifies assemblies from GAC that the package depends on.
//	FrameworkReferences []*FrameworkAssemblyReference
//
//	// PackageAssemblyReferences Returns sets of References specified in the manifest.
//	PackageAssemblyReferences []*PackageReferenceSet
//
//	// DependencyGroups Specifies sets other packages that the package depends on.
